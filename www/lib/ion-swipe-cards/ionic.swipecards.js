(function(ionic) {
  ...
  var SwipeableCardController = ionic.views.View.inherit({
    initialize: function(opts) {
      ...
      this.cardAnimation = opts.cardAnimation || 'zoomIn';
    },
    /**
  ...
  var SwipeableCardView = ionic.views.View.inherit({
    ...
    transitionOut: function(positive) {
      ...
      if((positive === true) || (this.x > 0)) {
        ...
        this.el.style[ionic.CSS.TRANSFORM] = 'translate3d(' + (window.innerWidth * 1.5) + 'px,' + this.y + 'px, 0)';
  ...
  .directive('swipeCard', ['$timeout', '$rootScope', function($timeout, $rootScope) {
    return {
      ...
      link: function($scope, $element, $attr, swipeCards) {
        ...
        $rootScope.$emit('cardCreated', swipeableCard);
